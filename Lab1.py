...
#get_vhi(change_reg(opn("C:\Users\Орест\Documents\КПІ\СРП\СРП\Lab1\Data")), 2010, 'Рівненська')
#col_graph(change_reg(opn("C:\Users\Орест\Documents\КПІ\СРП\СРП\Lab1\Data")))
#col_graph(clear_data(change_reg(opn("C:\Users\Орест\Documents\КПІ\СРП\СРП\Lab1\Data")), 0))
#graph(clear_data(change_reg(opn("C:\Users\Орест\Documents\КПІ\СРП\СРП\Lab1\Data")), 0), 'Київська', 2005)
